...
//   if (document.body.scrollTop > 750 || window.scrollY > 750) {
...
document.querySelector(".icon").addEventListener("click", function () {
  arrow.style.maxHeight == "1rem" || arrow.style.maxHeight == ""
    ? (arrow.style.maxHeight = "50rem")
    : (arrow.style.maxHeight = "1rem");
...
banners.forEach((banner) => {
  banner.addEventListener("click", function () {
    ...
    banner.id === "english"
      ? ((box.style.display = "none"), (box2.style.display = "flex"))
      : ((box.style.display = "flex"), (box2.style.display = "none"));
  });
});
